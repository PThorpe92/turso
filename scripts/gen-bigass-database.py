...
parser.add_argument("--scale", type=float, default=1.0, help="Scale factor for row counts (default: 1.0)")
parser.add_argument("--output", type=str, default="testing/testing-bigass.db", help="Output database path")
...
parser.add_argument(
    "--inventory", type=int, default=None, help="Number of inventory transactions (default: 18000 * scale)"
)  # noqa: E501
