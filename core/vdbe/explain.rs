...
pub fn insn_to_row(
    ...
    match insn {
        ...
        Insn::HashBuild{cursor_id, key_start_reg, num_keys, hash_table_reg, mem_budget} => (
            "HashBuild",
            *cursor_id as i32,
            *key_start_reg as i32,
            *num_keys as i32,
        ...
        Insn::HashNext{hash_table_reg, target_pc} => (
            "HashNext",
            *hash_table_reg as i32,
            target_pc.as_debug_int(),
            0,
